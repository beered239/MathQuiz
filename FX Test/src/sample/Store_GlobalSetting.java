...
public class Store_GlobalSetting extends Store_Setting{
    ...
    public void submitGlobalChanges() throws IOException{
        ...
        for(int i=0; i<values.size(); i++){
            outFile.println(names.get(i) + " " + Main.basicInputA[i].getText());
        }
        outFile.close();
    }
    ...
    public void calcPercentageCorrect(){
        ...
        scorePercentageD = Main.filter.roundTo(scorePercentageD,2);
        if(Main.filter.findNumOfDec(scorePercentageD) == 0)
