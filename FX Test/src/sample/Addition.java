...
public class Addition extends Operator{
    ...
    //private variables
        ...
        public static Integer[] pt2Range;// = Main.DivisionS.getRangeValuesFromSetting(Main.AdditionS.values.get(3));//fix
        public static int practiceNum;// = Main.filter.fixI(Main.AdditionS.values.get(5));//fix
    public Addition(){
        setSymbol(Symbols.PLUS);
        //numOfQ = Integer.parseInt(Main.AdditionS.values.get(1));
        pt2Range = Main.AdditionS.getRangeValuesFromSetting(Main.AdditionS.values.get(3));
        practiceNum = Main.filter.fixI(Main.AdditionS.values.get(5));
    }
    ...
    public void genPt2(){
        ...
        super.genPt2(Main.AdditionS,difficultyValAdd,4);
    }
