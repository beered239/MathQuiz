package sample;//this method will use objects just in case you want to complicate things further with multiple types of division settings
...
public class Division extends Operator {
    ...
    public static Integer[] pt2Range = Main.DivisionS.getRangeValuesFromSetting(Main.DivisionS.values.get(3));

    public static int practiceNum = Main.filter.fixI(Main.DivisionS.values.get(5));

    public Division(){
        setSymbol(Symbols.DIVIDE);
        numOfQ = Integer.parseInt(Main.DivisionS.values.get(1));
    }
    ...
    public void genPt2(){
        ...
        super.genPt2(Main.DivisionS,difficultyValDiv,5);
    }
