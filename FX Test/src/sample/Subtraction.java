...
public class Subtraction extends Operator{
    ...
    public Subtraction(){
        ...
        pt2Range = Main.SubtractionS.getRangeValuesFromSetting(Main.SubtractionS.values.get(3));
        practiceNum = Main.filter.fixI(Main.SubtractionS.values.get(5));
    }
     ...
     * */
        public void genPt2(){
            ...
            super.genPt2(Main.SubtractionS,difficultyValSub,4);
        }
