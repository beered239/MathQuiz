...
public class Multiplication extends Operator{
    ...
    public Multiplication(){
        ...
        pt2Range = Boot.MultiplicationS.getRangeValuesFromSetting(Boot.MultiplicationS.values.get(3));
        practiceNum = Boot.filter.fixI(Boot.MultiplicationS.values.get(5));
    }
    ...
    public void genPt2(){
        ...
        super.genPt2(Boot.MultiplicationS,difficultyValMulti,6);
    }
